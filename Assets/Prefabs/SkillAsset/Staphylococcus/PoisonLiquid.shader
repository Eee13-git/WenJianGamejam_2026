Shader "Custom/PoisonLiquid"
{
    Properties
    {
        _Radius ("Radius", Float) = 2
        _Color ("Color", Color) = (0.2, 0.7, 0.3, 0.85)
        _ColorEdge ("Edge Color", Color) = (0.55, 1.0, 0.45, 0.5)
        _BubbleColor ("Bubble Color", Color) = (0.7, 1.0, 0.5, 1.0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                col.rgb += _BubbleColor.rgb * bubble * 0.6;
                col.rgb *= ripple;
